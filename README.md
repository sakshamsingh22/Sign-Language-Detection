...
pip install opencv-python cvzone mediapipe==0.10.14 tf-keras scipy pyttsx3

# 4. Data Collection (Optional - to add more data)
...
TF_USE_LEGACY_KERAS=1 python test.py
```
